...
const priceMySlider = document.querySelector('.price-filter__slider');

noUiSlider.create(priceMySlider, {
	start: [0, 200000],
	connect: true,
...
function setPriceValues() {
	...
	priceMySlider.noUiSlider.set([priceStartValue, priceEndValue]);
}
